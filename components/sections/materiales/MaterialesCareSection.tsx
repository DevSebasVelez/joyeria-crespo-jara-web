        ...
        <div className="grid gap-4 md:grid-cols-2">
          <article className="card rounded-3xl border border-[#dbc7a5] bg-white p-6">
            ...
            <ul className="mt-3 space-y-2 text-[#5f4f3d]">
              ...
              <li>• Limpieza suave después de uso frecuente.</li>
            </ul>
          </article>
          <article className="card rounded-3xl border border-[#dbc7a5] bg-white p-6">
            <h3 className="text-2xl text-[#2f241a]">Servicio postventa</h3>
            <ul className="mt-3 space-y-2 text-[#5f4f3d]">
              <li>• Recomendaciones según material.</li>
              <li>• Ajustes de uso y conservación.</li>
              <li>• Asesoría para brillo y vida útil prolongada.</li>
            </ul>
          </article>
        </div>
      </div>
